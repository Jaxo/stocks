  ...
  <body>
    ...
    <script>
      ...
      const DEFAULT_PORTFOLIOS = [
        ...
        {'name': 'Tech', 'symbols': ['AAPL', 'GOOGL', 'MSFT', 'AMZN', 'FB', 'TWTR', 'NFLX', 'UBER', 'LYFT', 'SNAP', 'PINS', 'SPOT', 'DBX', 'SQ', 'SFIX', 'PD', 'BABA', 'INTC', 'AMD', 'NVDA', 'ORCL']},
      ...
      const API_TOKEN = 'f3d7b0facb16459aa117d4f16631b79e';
